...
setuptools.setup(
    ...
    # define if required # install_requires = oRepositoryConfig.Get('INSTALLREQUIRES'),
    # define if required # entry_points={
    # define if required #    'console_scripts': oRepositoryConfig.Get('CONSOLESCRIPTS'),
    # define if required #    },
